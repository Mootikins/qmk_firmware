...
[BASE] = LAYOUT_gergo(
    ...
    KC_LCTL, KC_A, KC_S, KC_D, KC_F,    KC_G,    KC_LBRC,                                KC_RBRC, KC_H,     KC_J,   KC_K,    KC_L,   KC_SCLN, KC_QUOTE,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V,    KC_B,    KC_LPRN, KC_DEL,                KC_ESC, KC_RPRN, KC_N,     KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_EQL,
                               KC_LALT, KC_LGUI, KC_BSPC,  TT(NUMB),     LT(EXT,KC_ENT), KC_SPC,  KC_GRAVE, KC_BSLASH
    ),
